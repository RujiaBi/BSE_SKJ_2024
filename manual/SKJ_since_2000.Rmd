...
```{r global setup}
devtools::install_github('RujiaBi/BSE_SKJ_2024',ref='main') 
library(BSE)
...
```{r}
SKJ.OBJ.Catch.20002021<-compile.catch.output.f(yr.start,yr.end,PS=PS,Species=Species,c("A1","A2","A3","A4","A5")) # five OBJ fisheries
...
```{r}
SKJ.NOA.Catch.20002021<-compile.catch.output.f(yr.start,yr.end,PS=PS,Species=Species,c("A1","A2","A3","A4","A5"))  # five NOA fisheries
